...
def write_yaml_4pool(cfg, yaml_fn=None):
    if yaml_fn is None:
        raise ValueError("yaml_fn must be defined")
    ...
    # Small description
    yaml_struct['description'] = 'A parameter file for mouse Glu CEST-MRF experiment'
    ...
    yaml_struct['cest_pool'] = {}
    # Amide solute pool
    yaml_struct['cest_pool']['Amide'] = {}

    yaml_struct['cest_pool']['Amide']['t1'] = cfg.cest_amide_t1
    yaml_struct['cest_pool']['Amide']['t2'] = cfg.cest_amide_t2
    yaml_struct['cest_pool']['Amide']['k'] = cfg.cest_amide_k
    yaml_struct['cest_pool']['Amide']['f'] = cfg.cest_amide_f
    yaml_struct['cest_pool']['Amide']['dw'] = cfg.cest_amide_dw

    # Glutamate solute pool
    yaml_struct['cest_pool']['Glu'] = {}

    yaml_struct['cest_pool']['Glu']['t1'] = cfg.cest_glu_t1
    yaml_struct['cest_pool']['Glu']['t2'] = cfg.cest_glu_t2
    yaml_struct['cest_pool']['Glu']['k'] = cfg.cest_glu_k
    yaml_struct['cest_pool']['Glu']['f'] = cfg.cest_glu_f
    yaml_struct['cest_pool']['Glu']['dw'] = cfg.cest_glu_dw
