...
def create_seq_defs_40():
    seq_defs = {}
    seq_defs['b1'] = [1.0, 1.3, 1.7, 1.9, 1.1, 1.4, 1.8, 1.2, 1.3, 1.5, 1.9, 0.9, 1.4, 1.7, 1.0, 1.0, 1.5, 1.8, 1.0, 1.1,
                      1.7, 1.9, 1.0, 1.3, 1.8, 1.0, 1.1, 1.4, 1.9, 1.1, 1.3, 1.0, 1.3, 1.0, 1.4, 1.7, 1.2, 1.1, 1.5, 1.8]
    seq_defs['offsets_ppm'] = [8, 8, 8, 8, 9, 9, 9, 9, 10, 10, 10, 10, 11, 11, 11, 11, 13, 13, 13, 13,
                                 15, 15, 15, 15, 20, 20, 20, 20, 25, 25, 25, 25, 35, 35, 35, 35, 50, 50, 50, 50]
    seq_defs['tsat'] = [0.4, 0.9, 1.3, 1.8, 1.8, 0.4, 0.9, 1.3, 1.3, 1.8, 0.4, 0.9, 0.9, 1.3, 1.8, 0.4, 0.4, 0.9, 1.3, 1.8,
                        0.6, 1.1, 1.6, 2.0, 2.0, 0.6, 1.1, 1.6, 1.6, 2.0, 0.6, 1.1, 1.1, 1.6, 2.0, 0.6, 0.6, 1.1, 1.6, 2.0]
    seq_defs['trec'] = [3.5, 4.0, 4.5, 3.6, 4.1, 4.3, 3.5, 3.7, 4.5, 3.6, 4.1, 4.0, 3.5, 4.0, 4.1, 3.6, 4.1, 4.3, 3.8, 4.0,
                        4.5, 3.6, 4.1, 4.3, 3.5, 4.0, 4.5, 3.6, 4.1, 4.0, 3.5, 4.0, 4.4, 3.6, 4.1, 4.3, 4.5, 4.0, 4.5, 3.6]

    return seq_defs    


def create_seq_defs_unsupervised(gamma = 267.5153, freq = 127.7153, clinical=False):
    seq_defs = create_seq_defs_40()
